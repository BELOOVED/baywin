...
<main onclick="loginorp1ay()">
   ...
   <app-games class="ng-star-inserted">
      <router-outlet></router-outlet>
      <app-betongames class="ng-star-inserted">
         <div class="breadcrumb-wrapper flex-container">
            <div class="breadcrumbs-cont flex-container flex-item">
               ...
               <a href="javascript:;" class="breadcrumb">Betongames</a>
            </div>
         </div>
         <!---->
...
<?php }else {?>
   ...
   <app-games class="ng-star-inserted">
      ...
      <app-betongames class="ng-star-inserted">
               ...
               <div class="row">
                  <div class="col s12 right-content">
                     <div class="flex-container clear">
                        <h4 class="rtitle flex-item"> Betongames </h4>
                     </div>
                     <!---->
                        ...
                        <div class="row">
                           <div class="col pg-grd-6 csn-crd-col ng-star-inserted">
                              <div class="csn-crd">
                                 ...
                                 <div class="crd-nm">
                                    <app-user-favorite classes="fvrt-lnk">
                                       <!---->
                                    </app-user-favorite>
                                    Lucky 7 
                                 </div>
         ...
         <!---->
         <app-static-inner-content contentcode="betongames-bottom">
            <!---->
         </app-static-inner-content>
      </app-betongames>
      <!---->
