            ...
            <payment-form class="ng-star-inserted">
               <div class="breadcrumb-wrapper flex-container">
                  <div class="breadcrumbs-cont flex-container flex-item">
                     ...
                     <!----><!----><a href="javascript:;" class="breadcrumb ng-star-inserted">Sistem Nakit Bank Deposit</a><!---->
                  </div>
               ...
               <!----><!----><!----><!----><!---->
               <div id="confirmPromptModal" materialize="modal" class="modal modal-sm dshbrd-modal" style="z-index: 1087;">
                  <app-confirm-promt>
                     <!---->
                  </app-confirm-promt>
               </div>
