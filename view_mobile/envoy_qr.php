            ...
            <payment-form class="ng-star-inserted">
               <div class="breadcrumb-wrapper flex-container">
                  <div class="breadcrumbs-cont flex-container flex-item">
                     ...
                     <!----><!----><a href="javascript:;" class="breadcrumb ng-star-inserted">Envoy Hızlı QR Yatırım</a><!---->
                  </div>
               ...
               <div class="payment-form-container ng-star-inserted">
                  ...
                  <ul class="collection with-header ng-star-inserted">
                     ...
                     <!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
                     <li class="collection-item ng-star-inserted"><i class="material-icons left">info</i><span>Para yatırım miktarı 10 ve katları şeklinde olmalıdır</span></li>
                     <!----><!----><!---->
                     <app-static-inner-content class="ng-star-inserted">
                        <!---->
                     </app-static-inner-content>
   ...
   <payments-widget>
      <owl-carousel-o _nghost-yib-c77="" class="ng-star-inserted">
         <div _ngcontent-yib-c77="" class="owl-carousel owl-theme owl-loaded owl-drag">
            <div _ngcontent-yib-c77="" class="owl-stage-outer ng-star-inserted">
               <owl-stage _ngcontent-yib-c77="" class="ng-tns-c78-4 ng-star-inserted">
                  <div class="ng-tns-c78-4">
                     <div class="owl-stage ng-tns-c78-4" style="width: 5250px; transform: translate3d(-1350px, 0px, 0px); transition: all 0s ease 0s;">
                        ...
                        <!---->
                        <div class="owl-item ng-tns-c78-4 ng-trigger ng-trigger-autoHeight active ng-star-inserted" style="width: 130px; margin-right: 20px;">
                           <div class="col s12 ng-star-inserted" style="">
            ...
            <!---->
            <div _ngcontent-yib-c77="" class="owl-nav ng-star-inserted">
               <div _ngcontent-yib-c77="" class="owl-prev"><i class="material-icons">chevron_left</i></div>
               <div _ngcontent-yib-c77="" class="owl-next"><i class="material-icons">chevron_right</i></div>
            </div>
            <div _ngcontent-yib-c77="" class="owl-dots disabled ng-star-inserted">
               <!---->
            </div>
            <!----><!---->
         </div>
