<main>
   ...
   <app-dashboard class="ng-star-inserted">
      ...
      <payment-component class="ng-star-inserted">
         <router-outlet></router-outlet>
         <payment-form-out class="ng-star-inserted">
            <!---->
            <payment-form class="ng-star-inserted">
               ...
               <div class="payment-form-container ng-star-inserted">
                  <div class="modul-accordion-account ng-star-inserted">
                     <div class="modul-content">
                        ...
                        <!----><!----><!---->
                        <form action="/payfix/" method="POST" novalidate="" class="ng-untouched ng-pristine ng-invalid ng-star-inserted">
                           <app-static-inner-content class="ng-star-inserted">
                              <!---->
                           </app-static-inner-content>
                           <!----><!----><!----><!----><!---->
                           <div class="money-detail-content">
                              <div class="selection-form-contents">
                                 <div class="selection-title ng-star-inserted">
                                    <div class="text">
                                       Min: 25.00 ₺ / Max: 50,000.00 ₺ <span class="processing-time ng-star-inserted">| Ortalama İşlem Süresi : ANINDA Dk</span><!---->
                                    </div>
                                 </div>
                                 <!----><!----><!----><!----><!---->
                                 <already-amounts class="ng-star-inserted">
                                    <div class="amount-filed-cont ng-star-inserted">
                                       
                                       <!---->
                                       <div>
                                          <span class="field-label ng-star-inserted">Miktar (Yatırım Para Birimi)</span><!----><!----><input type="text" id="mntNpt" debounce="1000" currency-mask="" name="amount" autocomplete="off" class="account-input browser-default ng-untouched ng-pristine ng-invalid ng-star-inserted" placeholder="Yatırım Tutarı"><!----><!----><!----><!----><!---->
                                       </div>
                                       <!---->
                                    </div>
                                    <!---->
                                 ...
                                 <!---->
                                 <bonus-and-freebet class="ng-star-inserted">
                                    <!----><!----><!----><!---->
                                 </bonus-and-freebet>
                                 <!----><!----><!----><!---->
                                 <app-notifications>
               ...
               <!----><!----><!----><!----><!---->
               <div id="confirmPromptModal" materialize="modal" class="modal modal-sm dshbrd-modal" style="z-index: 1045;">
                  <app-confirm-promt>
                     <!---->
                  </app-confirm-promt>
               </div>
   ...
   <!---->
   <payments-widget>
      <owl-carousel-o _nghost-xbs-c77="" class="ng-star-inserted">
         <div _ngcontent-xbs-c77="" class="owl-carousel owl-theme owl-loaded owl-drag">
            <div _ngcontent-xbs-c77="" class="owl-stage-outer ng-star-inserted">
               <owl-stage _ngcontent-xbs-c77="" class="ng-tns-c78-3 ng-star-inserted">
                  <div class="ng-tns-c78-3">
                     <div class="owl-stage ng-tns-c78-3" style="width: 15972px; transform: translate3d(-4106px, 0px, 0px); transition: all 0s ease 0s;">
                        <div class="owl-item ng-tns-c78-3 ng-trigger ng-trigger-autoHeight cloned ng-star-inserted" style="width: 436.333px; margin-right: 20px;">
                           <!---->
                        </div>
                        <!---->
                        <div class="owl-item ng-tns-c78-3 ng-trigger ng-trigger-autoHeight cloned ng-star-inserted" style="width: 436.333px; margin-right: 20px;">
                        ...
                        <!---->
                        <div class="owl-item ng-tns-c78-3 ng-trigger ng-trigger-autoHeight active ng-star-inserted" style="width: 436.333px; margin-right: 20px;">
                           <div class="col s12 ng-star-inserted" style="">
                        ...
                        <!---->
                        <div class="owl-item ng-tns-c78-3 ng-trigger ng-trigger-autoHeight ng-star-inserted" style="width: 436.333px; margin-right: 20px;">
                           <div class="col s12 ng-star-inserted" style="">
            ...
            <!---->
            <div _ngcontent-xbs-c77="" class="owl-nav ng-star-inserted">
               <div _ngcontent-xbs-c77="" class="owl-prev"><i class="material-icons">chevron_left</i></div>
               <div _ngcontent-xbs-c77="" class="owl-next"><i class="material-icons">chevron_right</i></div>
            </div>
            <div _ngcontent-xbs-c77="" class="owl-dots disabled ng-star-inserted">
               <!---->
            </div>
            <!----><!---->
         </div>
