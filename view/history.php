         ...
         <bet-history class="ng-star-inserted">
            <div class="breadcrumb-wrapper flex-container ng-star-inserted">
               <div class="breadcrumbs-cont flex-container flex-item">
                  ...
                  <a href="javascript:;" class="breadcrumb">Bahis Geçmişim</a>
               </div>
               <div class="filter-toggle bet-history-filter">
                  <a href="javascript:;" class="filter-toggle-btn">
                     <i class="fa fa-filter"></i> Filtrele 
                     <select select-modal="" class="browser-default ng-untouched ng-pristine ng-valid ng-star-inserted">
                        <option value="CO" class="ng-star-inserted">Bahis Bozdur</option>
                        <!---->
                        <option value="O" class="ng-star-inserted">Tamamlanmamış</option>
                        <!---->
                        <option value="C" class="ng-star-inserted">Bozdurulan</option>
                        <!---->
                        <option value="W" class="ng-star-inserted">Kazanç</option>
                        <!---->
                        <option value="L" class="ng-star-inserted">Kayıp</option>
                        <!---->
                        <option value="V" class="ng-star-inserted">Geçersiz</option>
                        <!---->
            ...
            <!----><!---->
            <div class="modul-accordion-account bet-history-filter-text ng-star-inserted"><span class="field-label">Bahis Bozdur</span></div>
            <!----><!---->
