                        ...
                        <ul class="money-list-menu">
                              ...
                              <a queryparamshandling="merge" class="flex-container" data-payment="envoysoft-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/envoysoft-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=Envoy Hızlı Havale Çekim" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/common/assets/images/payments/withdraw-413.png" width="100" height="33" class="envoysoft-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                           ...
                           <li class="ng-star-inserted">
                              <a queryparamshandling="merge" class="flex-container" data-payment="papara-form-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/papara-form-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=Papara Çekim Form" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/common/assets/images/payments/withdraw-270.png" width="100" height="33" class="papara-form-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                                 <ul class="flex-item info">
                           ...
                           <li class="ng-star-inserted">
                              <a queryparamshandling="merge" class="flex-container" data-payment="upaycoins-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/upaycoins-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=YouPayCoin Çekim" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/common/assets/images/payments/withdraw-715.png" width="100" height="33" class="upaycoins-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                                 <ul class="flex-item info">
                           ...
                           <li class="ng-star-inserted">
                              <a queryparamshandling="merge" class="flex-container" data-payment="payfix-form-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/payfix-form-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=Payfix Çekim Form" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/common/assets/images/payments/withdraw-836.png" width="100" height="33" class="payfix-form-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                                 <ul class="flex-item info">
                           ...
                           <li class="ng-star-inserted">
                              <a queryparamshandling="merge" class="flex-container" data-payment="seripopy-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/seripopy-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=Seripopy Withdraw" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/limanbet/upload_files/withdraw-1872.png" width="100" height="33" class="seripopy-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                                 <ul class="flex-item info">
                           ...
                           <li class="ng-star-inserted">
                              <a queryparamshandling="merge" class="flex-container" data-payment="starpay-papara-withdraw" href="/tr/dashboard/payments/withdraw-money/detail/starpay-papara-withdraw">
                                 <div class="img-wrapper ng-star-inserted">
                                    <payment-icon width="100" height="33">
                                       <img src="https://via.placeholder.com/100x33.png?text=Starpay Papara Withdraw" width="100" height="33" class="hide" hidden=""><img src="//v3.pronetstatic.com/limanbet/upload_files/withdraw-1870.png" width="100" height="33" class="starpay-papara-withdraw"><!---->
                                    </payment-icon>
                                 </div>
                                 <!----><!----><br>
                                 <ul class="flex-item info">
