      ...
      <app-poker class="ng-star-inserted">
         ...
         <div class="row casino-content">
            ...
            <div class="col s6 game-card">
               <div class="card-image"><a class="modal-trigger"><img alt="" class="game-img" src="//v3.pronetstatic.com/m-common/assets/images/poker/texas-holdem.jpg"><img alt="" class="game-img loading" src="//v3.pronetstatic.com/m-common/assets/images/loading.gif"></a></div>
               <a class="modal-trigger poker-game-btn"> Gerçek Oyun</a>
            </div>
            <div class="col s6 game-card">
               <div class="card-image"><a class="modal-trigger"><img alt="" class="game-img" src="//v3.pronetstatic.com/m-common/assets/images/poker/omaha.jpg"><img alt="" class="game-img loading" src="//v3.pronetstatic.com/m-common/assets/images/loading.gif"></a></div>
               <a class="modal-trigger poker-game-btn"> Gerçek Oyun</a>
            </div>
            <div class="col s6 game-card">
               <div class="card-image"><a class="modal-trigger"><img alt="" class="game-img" src="//v3.pronetstatic.com/m-common/assets/images/poker/turkishpoker.jpg"><img alt="" class="game-img loading" src="//v3.pronetstatic.com/m-common/assets/images/loading.gif"></a></div>
               <a class="modal-trigger poker-game-btn"> Gerçek Oyun</a>
            </div>
            <div class="col s6 game-card">
               <div class="card-image"><a class="modal-trigger"><img alt="" class="game-img" src="//v3.pronetstatic.com/m-common/assets/images/poker/tavla.jpg"><img alt="" class="game-img loading" src="//v3.pronetstatic.com/m-common/assets/images/loading.gif"></a></div>
               <a class="modal-trigger poker-game-btn"> Gerçek Oyun</a>
            </div>
         </div>
